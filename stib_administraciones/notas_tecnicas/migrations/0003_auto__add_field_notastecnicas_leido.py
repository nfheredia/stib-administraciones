...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NotasTecnicas.leido'
        db.add_column(u'notas_tecnicas_notastecnicas', 'leido',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NotasTecnicas.leido'
        db.delete_column(u'notas_tecnicas_notastecnicas', 'leido')
