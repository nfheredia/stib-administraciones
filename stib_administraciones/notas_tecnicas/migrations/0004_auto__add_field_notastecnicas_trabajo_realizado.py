...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NotasTecnicas.trabajo_realizado'
        db.add_column(u'notas_tecnicas_notastecnicas', 'trabajo_realizado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NotasTecnicas.trabajo_realizado'
        db.delete_column(u'notas_tecnicas_notastecnicas', 'trabajo_realizado')
    ...
    models = {
        ...
        u'notas_tecnicas.notastecnicas': {
            'Meta': {'ordering': "['-creado']", 'object_name': 'NotasTecnicas'},
            ...
            'trabajo_realizado': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
