...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RelacionesUsuariosServicios.mail_recibido'
        db.add_column(u'relaciones_relacionesusuariosservicios', 'mail_recibido',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RelacionesUsuariosProductos.mail_recibido'
        db.add_column(u'relaciones_relacionesusuariosproductos', 'mail_recibido',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RelacionesEdificiosProductos.mail_recibido'
        db.add_column(u'relaciones_relacionesedificiosproductos', 'mail_recibido',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RelacionesEdificiosServicios.mail_recibido'
        db.add_column(u'relaciones_relacionesedificiosservicios', 'mail_recibido',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RelacionesUsuariosServicios.mail_recibido'
        db.delete_column(u'relaciones_relacionesusuariosservicios', 'mail_recibido')

        # Deleting field 'RelacionesUsuariosProductos.mail_recibido'
        db.delete_column(u'relaciones_relacionesusuariosproductos', 'mail_recibido')

        # Deleting field 'RelacionesEdificiosProductos.mail_recibido'
        db.delete_column(u'relaciones_relacionesedificiosproductos', 'mail_recibido')

        # Deleting field 'RelacionesEdificiosServicios.mail_recibido'
        db.delete_column(u'relaciones_relacionesedificiosservicios', 'mail_recibido')
