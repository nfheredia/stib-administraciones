...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RelacionesUsuariosServicios.estado'
        db.add_column(u'relaciones_relacionesusuariosservicios', 'estado',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'RelacionesUsuariosProductos.estado'
        db.add_column(u'relaciones_relacionesusuariosproductos', 'estado',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'RelacionesEdificiosProductos.estado'
        db.add_column(u'relaciones_relacionesedificiosproductos', 'estado',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'RelacionesEdificiosServicios.estado'
        db.add_column(u'relaciones_relacionesedificiosservicios', 'estado',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RelacionesUsuariosServicios.estado'
        db.delete_column(u'relaciones_relacionesusuariosservicios', 'estado')

        # Deleting field 'RelacionesUsuariosProductos.estado'
        db.delete_column(u'relaciones_relacionesusuariosproductos', 'estado')

        # Deleting field 'RelacionesEdificiosProductos.estado'
        db.delete_column(u'relaciones_relacionesedificiosproductos', 'estado')

        # Deleting field 'RelacionesEdificiosServicios.estado'
        db.delete_column(u'relaciones_relacionesedificiosservicios', 'estado')
