...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'TipoRelaciones', fields ['nombre']
        db.delete_unique(u'relaciones_tiporelaciones', ['nombre'])


    def backwards(self, orm):
        # Adding unique constraint on 'TipoRelaciones', fields ['nombre']
        db.create_unique(u'relaciones_tiporelaciones', ['nombre'])
    ...
    models = {
        ...
        u'relaciones.relacionesedificiosproductos': {
            ...
            'titulo': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '150'})
        },
