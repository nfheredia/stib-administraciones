...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'fotos_fotos', (
            ...
            ('categoria', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fotos.CategoriasFotos'])),
    ...
    models = {
        ...
        u'fotos.fotos': {
            ...
            'categoria': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fotos.CategoriasFotos']"}),
            'comentario': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'creado': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
