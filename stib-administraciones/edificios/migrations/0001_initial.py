...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Edificios'
        db.create_table(u'edificios_edificios', (
            ...
            ('foto_fachada', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('cantidad_pisos', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True, blank=True)),
            ('cantidad_unidades', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True, blank=True)),
            ('comentario', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'edificios', ['Edificios'])


    def backwards(self, orm):
        # Deleting model 'Edificios'
        db.delete_table(u'edificios_edificios')
