...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Edificios', fields ['user']
        db.delete_unique(u'edificios_edificios', ['user_id'])


        # Changing field 'Edificios.user'
        db.alter_column(u'edificios_edificios', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User']))

    def backwards(self, orm):

        # Changing field 'Edificios.user'
        db.alter_column(u'edificios_edificios', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['users.User'], unique=True))
        # Adding unique constraint on 'Edificios', fields ['user']
        db.create_unique(u'edificios_edificios', ['user_id'])
