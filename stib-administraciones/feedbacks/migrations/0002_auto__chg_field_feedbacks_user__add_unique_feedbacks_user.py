...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Feedbacks.user'
        db.alter_column(u'feedbacks_feedbacks', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['users.User'], unique=True))
        # Adding unique constraint on 'Feedbacks', fields ['user']
        db.create_unique(u'feedbacks_feedbacks', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Feedbacks', fields ['user']
        db.delete_unique(u'feedbacks_feedbacks', ['user_id'])


        # Changing field 'Feedbacks.user'
        db.alter_column(u'feedbacks_feedbacks', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User']))
